...
WebUI.verifyElementVisible(findTestObject('Page_Automation Exercise - Checkout/a_Men Tshirt'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('Page_Automation Exercise - Checkout/a_Pure Cotton V-Neck T-Shirt'))
